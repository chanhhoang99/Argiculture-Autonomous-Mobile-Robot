...
double wheelbase = 0.3;                          //Wheelbase, in m
...
int main(int argc, char** argv){
  ...
  double rate = 10.0;
  double linear_scale_positive = 0.7;
  double linear_scale_negative = 0.7;
  double angular_scale_positive = 0.35;
  double angular_scale_negative = 0.35;
